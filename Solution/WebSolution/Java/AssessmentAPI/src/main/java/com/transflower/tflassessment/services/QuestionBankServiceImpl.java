...
public class QuestionBankServiceImpl implements QuestionBankService {
    ...
    public CompletableFuture<List<QuestionTitle>> getAllQuestions() {
        ...
        return CompletableFuture.completedFuture(repository.getAllQuestions());
    }
    ...
    public CompletableFuture<Question> getQuestion(int questionId) {
        ...
        return CompletableFuture.completedFuture(repository.getQuestion(questionId));
    }
    ...
    public CompletableFuture<List<Question>> getQuestions(int testId) {
        System.out.println("Executing getQuestion on: " + Thread.currentThread().getName());
        return CompletableFuture.completedFuture(repository.getQuestions(testId));
    }
    ...
    public CompletableFuture<List<SubjectQuestion>> getQuestionsBySubject(int id) {
        System.out.println("Executing getQuestion on: " + Thread.currentThread().getName());
        return CompletableFuture.completedFuture(repository.getQuestionsBySubject(id));
    }
    ...
    public CompletableFuture<List<QuestionDetails>> getQuestionsBySubjectAndCriteria(int subjectId, int criteriaId) {
        System.out.println("Executing getQuestion on: " + Thread.currentThread().getName());
        return CompletableFuture.completedFuture(repository.getQuestionsBySubjectAndCriteria(subjectId, criteriaId));
    }
    ...
    public CompletableFuture<List<QuestionDetails>> getQuestionsWithSubjectAndCriteria() {
         System.out.println("Executing getQuestion on: " + Thread.currentThread().getName());
        return CompletableFuture.completedFuture(repository.getQuestionsWithSubjectAndCriteria());
    }
    ...
    public CompletableFuture<Boolean> updateAnswer(int id, char answerKey) {
         System.out.println("Executing getQuestion on: " + Thread.currentThread().getName());
        return CompletableFuture.completedFuture(repository.updateAnswer(id, answerKey));
    }
    ...
    public CompletableFuture<Boolean> updateQuestionOptions(int id, Question options) {
         System.out.println("Executing getQuestion on: " + Thread.currentThread().getName());
        return CompletableFuture.completedFuture(repository.updateQuestionOptions(id, options));
    }
    ...
    public CompletableFuture<Boolean> updateSubjectCriteria(int questionId, Question question) {
         System.out.println("Executing getQuestion on: " + Thread.currentThread().getName());
        return CompletableFuture.completedFuture(repository.updateSubjectCriteria(questionId, question));
    }
    ...
    public CompletableFuture<Boolean> insertQuestion(NewQuestion question) {
         System.out.println("Executing getQuestion on: " + Thread.currentThread().getName());
        return CompletableFuture.completedFuture(repository.insertQuestion(question));
    }
    ...
    public CompletableFuture<String> getCriteria(String subject, int questionId) {
         System.out.println("Executing getQuestion on: " + Thread.currentThread().getName());
        return CompletableFuture.completedFuture(repository.getCriteria(subject, questionId));
    }
