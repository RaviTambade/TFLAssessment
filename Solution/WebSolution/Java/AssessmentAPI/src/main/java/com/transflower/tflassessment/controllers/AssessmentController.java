...
public class AssessmentController {
    ...
    public CompletableFuture<List<Assessment>> getAll(
            @PathVariable("fromDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDateTime fromDate,
    ...
    public CompletableFuture<List<EvaluationCriteria>> getEvaluationCriteriasBySubject(
    ...
    public CompletableFuture<Boolean> addQuestion(@PathVariable("assessmentId") int assessmentId,
    ...
    public CompletableFuture<Boolean> addQuestions(@PathVariable("assessmentId") int assessmentId,
                                                   @RequestBody List<QuestionBank> questions) {
        return svc.addQuestions(assessmentId, questions);
    }

    @DeleteMapping("/api/assessment/{assessmentId}/questions/{questionId}")
    public CompletableFuture<Boolean> removeQuestion(@PathVariable("assessmentId") int assessmentId,
                                                     @PathVariable("questionId") int questionId) {
        return svc.removeQuestion(assessmentId, questionId);
    }

    @PutMapping("/api/assessment/{assessmentId}/duration/{duration}")
    public CompletableFuture<Boolean> changeDuration(@PathVariable("assessmentId") int assessmentId,
    ...
    public CompletableFuture<Boolean> reschedule(@PathVariable("assessmentId") int assessmentId,
    ...
    public CompletableFuture<Boolean> updateQuestion(@PathVariable int questionId,
    ...
    public CompletableFuture<Boolean> updateTestStatus(@PathVariable("testId") int testId,
                                                       @RequestBody TestStatusUpdate status) {
