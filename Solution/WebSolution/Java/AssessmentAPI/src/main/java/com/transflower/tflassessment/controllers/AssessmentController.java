...
public class AssessmentController {
    ...
    public CompletableFuture<List<Assessment>> getAll( @PathVariable("fromDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) LocalDateTime fromDate,
    ...
    @GetMapping("/api/assessment/concepts")
    public CompletableFuture<List<Concepts>> getConcepts() {
        return svc.getConcepts();
    }

    @GetMapping("/api/assessment/concepts/subjects/{subjectId}")
    public CompletableFuture<List<Concepts>> getConceptsBySubject(@PathVariable("subjectId") int subjectId) {
        return svc.getConceptsBySubject(subjectId);
    }
    ...
    //         @PathVariable("ConceptsId") int ConceptsId) {
    //     return svc.getQuestionsByConceptsId(ConceptsId);
    // }
