...
(user_id, user_login, user_logout, session_duration) 
VALUES

-- 1 Ravi (Active session)
(1, DATE_SUB(NOW(), INTERVAL 30 MINUTE), NULL, NULL),

-- 2 Kajal (Logged out)
(2, DATE_SUB(NOW(), INTERVAL 2 HOUR), DATE_SUB(NOW(), INTERVAL 1 HOUR), '01:00:00'),

-- 3 Sarthak (Active)
(3, DATE_SUB(NOW(), INTERVAL 45 MINUTE), NULL, NULL),

-- 4 Nikita (Logged out)
(4, DATE_SUB(NOW(), INTERVAL 3 HOUR), DATE_SUB(NOW(), INTERVAL 2 HOUR), '01:00:00'),

-- 5 Rutuja (Active)
(5, DATE_SUB(NOW(), INTERVAL 1 HOUR), NULL, NULL),

-- 6 Pranita (Active)
(6, DATE_SUB(NOW(), INTERVAL 20 MINUTE), NULL, NULL),

-- 7 Sahil (Logged out)
(7, DATE_SUB(NOW(), INTERVAL 2 HOUR), DATE_SUB(NOW(), INTERVAL 30 MINUTE), '01:30:00'),

-- 8 Nirjala (Active)
(8, DATE_SUB(NOW(), INTERVAL 10 MINUTE), NULL, NULL),

-- 9 Chaitrali (Old session)
(9, DATE_SUB(NOW(), INTERVAL 3 HOUR), DATE_SUB(NOW(), INTERVAL 2 HOUR), '01:00:00'),

-- 9 Chaitrali (Current Active)
(9, DATE_SUB(NOW(), INTERVAL 25 MINUTE), NULL, NULL),

-- 10 Arnav (Laptop session)
(10, DATE_SUB(NOW(), INTERVAL 1 HOUR), NULL, NULL),

-- 10 Arnav (Mobile session)
(10, DATE_SUB(NOW(), INTERVAL 15 MINUTE), NULL, NULL),

-- 11 Tejas (Expired)
(11, DATE_SUB(NOW(), INTERVAL 4 HOUR), DATE_SUB(NOW(), INTERVAL 3 HOUR), '01:00:00'),

-- 12 Sai (Expired)
(12, DATE_SUB(NOW(), INTERVAL 2 HOUR), DATE_SUB(NOW(), INTERVAL 1 HOUR), '01:00:00'),

-- 13 Samruddhi (Expired)
(13, DATE_SUB(NOW(), INTERVAL 5 HOUR), DATE_SUB(NOW(), INTERVAL 4 HOUR), '01:00:00'),

-- 14 Yash (Active)
(14, DATE_SUB(NOW(), INTERVAL 40 MINUTE), NULL, NULL),

-- 15 Shrutik (Active)
(15, DATE_SUB(NOW(), INTERVAL 1 HOUR), NULL, NULL),

-- 16 Sumit (Active)
(16, DATE_SUB(NOW(), INTERVAL 35 MINUTE), NULL, NULL),

-- 17 Sanika (Active)
(17, DATE_SUB(NOW(), INTERVAL 50 MINUTE), NULL, NULL),

-- 18 Sachin (Logged out)
(18, DATE_SUB(NOW(), INTERVAL 3 HOUR), DATE_SUB(NOW(), INTERVAL 2 HOUR), '01:00:00'),

-- 19 Abhay (Active)
(19, DATE_SUB(NOW(), INTERVAL 20 MINUTE), NULL, NULL),

-- 20 Prajwal (Active)
(20, DATE_SUB(NOW(), INTERVAL 15 MINUTE), NULL, NULL),

-- 21 Vibhavari (Logged out)
(21, DATE_SUB(NOW(), INTERVAL 2 HOUR), DATE_SUB(NOW(), INTERVAL 1 HOUR), '01:00:00'),

-- 22 Tanvi (Active)
(22, DATE_SUB(NOW(), INTERVAL 30 MINUTE), NULL, NULL);
