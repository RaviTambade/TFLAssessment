...
import ProjectAllocationPage from "@/components/assessment/evaluationcontent/ProjectAllocationPage";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20">
        <Routes> 
          ...
          <Route path="evaluationcontent/ProjectAllocationPage" element={<ProjectAllocationPage/>}/>
