                        ...
                        <div className="bg-gradient-hero p-6 sm:p-8">
                            <CardContent>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <Button onClick={() => navigate("/models/skilltaxonomy/smedashboard")} variant="hero" size="lg" className="group">
                                       SME Dashboard
                                        <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                                    </Button>

                                    <Button onClick={() => navigate("/skilltaxonomy/concept")} variant="hero" size="lg" className="group">
                                        Concept
                                        <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                                    </Button>
                                    ...
                                    <Button variant="hero" size="lg" className="group"
                                     ...
                                     <Button variant="hero" size="lg" className="group"
                                        onClick={() => navigate("/models/skilltaxonomy/layers")}>
                                        Layers
                                        <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                                    </Button>
