...
const buttons = [
  ...
  { label: "Assessment Orchestrator", path: "/models/assessment-orchestrator" },
  { label: "Evaluation Service", path: "/models/evaluation-service" },
  { label: "Insight Core", path: "/models/insight-core", span: 2 },
  { label: "Growth Engine", path: "/models/growth-engine", span: 2 },
  { label: "Membership", path: "/models/membership/MembershipMenu", span: 2 },
];
