...
public partial class TflcomentorDbContext : DbContext
{
    public TflcomentorDbContext()
    {
    }

    public TflcomentorDbContext(DbContextOptions<TflcomentorDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<HandsOnResult>(entity =>
        {
            ...
            entity.Property(e => e.Id)
                .HasColumnType("int(11)")
                .HasColumnName("id");
            entity.Property(e => e.HandsOnId)
                .HasColumnType("int(11)")
                .HasColumnName("hands_on_id");
        ...
        modelBuilder.Entity<LearningPathProgress>(entity =>
        {
            ...
            entity.Property(e => e.PerformanceLevelId)
                .HasColumnType("bigint(20)")
                .HasColumnName("performance_level_id");
            entity.Property(e => e.StudentId)
                .HasColumnType("bigint(20)")
                .HasColumnName("student_id");
        });
