...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            // The connection string is now primarily managed in Program.cs and appsettings.json.
            // This is a fallback to avoid errors if OnConfiguring is called without context options.
        }
    }
