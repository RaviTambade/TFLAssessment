...
public class ResultRepositoryImpl implements ResultRepository {
  ...
  static {
    ...
    public boolean setCandidateTestStartTime(int candidateId, int testId, LocalDateTime time) {
       ...
       String query= "insert into candidatetestresults(assessmentid,teststarttime,candidateid) values (?,?,?)";
       try{
    ...
    public List<AppearedCandidate> getAppearedCandidates(int assessmentId) {
      List<AppearedCandidate> appearedCandidates = new ArrayList<AppearedCandidate>();
        String query = "select candidatetestresults.assessmentid, candidatetestresults.candidateid, employees.firstname, employees.lastname"
                        ...
                        +" where candidatetestresults.assessmentid=?";
    ...
    public List<TestList> getTestList(int candidateId) {
        ...
        String query = "SELECT cr.assessmentid AS Id, cr.score AS Score, t.name AS TestName"
                        ...
                        +" JOIN tests t ON cr.assessmentid = t.id where candidateid=?";
    ...
    public List<PassedCandidateDetails> getPassedCandidateResults(int assessmentId) {
        ...
        String query = "select tests.id,candidatetestresults.candidateid,candidatetestresults.score,tests.passinglevel,employees.firstname,employees.lastname"
                        +" from tests"
                        +" inner join candidatetestresults on tests.id=candidatetestresults.assessmentid"
