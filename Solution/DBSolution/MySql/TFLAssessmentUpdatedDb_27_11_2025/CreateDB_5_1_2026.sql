...
CREATE TABLE subject_concepts (
    subject_concept_id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE questionbank (
    ...
    answerkey CHAR(1) NOT NULL CHECK (answerkey IN ('A','B','C','D')),
    difficulty_level ENUM('Beginner','Intermediate','Advanced','Expert') NOT NULL,
    created_by VARCHAR(100) NOT NULL,
    created_on DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (subject_concept_id) REFERENCES subject_concepts(subject_concept_id)
);
