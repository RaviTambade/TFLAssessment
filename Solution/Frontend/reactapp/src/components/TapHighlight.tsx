        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="order-2 lg:order-1">
              <img src={tapMentorshipImage} alt="TAP Program Mentorship" className="rounded-3xl shadow-elegant w-full"/>
            </div>
            ...
            <div className="space-y-4 sm:space-y-6 order-1 lg:order-2">
              ...
              <Card className="bg-card/50 backdrop-blur-sm border-0 shadow-elegant">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground"> Bridge the gap between education and employability</p>
                </CardContent>
              </Card>

              <div className="pt-4">
                <Link to="/tap-program">
                  <Button variant="hero" size="lg" className="group">Explore TAP Program
          ...
          <div className="mt-12 sm:mt-16 text-center">
            <div className="bg-card/30 backdrop-blur-sm rounded-3xl p-6 sm:p-8 shadow-elegant">
              ...
              <p className="text-xl sm:text-2xl font-bold bg-gradient-accent bg-clip-text text-transparent"> TAP your potential.</p>
            </div>
          </div>
        </div>
      </div>
