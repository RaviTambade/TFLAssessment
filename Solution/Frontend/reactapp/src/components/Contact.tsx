            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a href="https://www.linkedin.com/in/ravitambade/" target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-smooth"   >
                    <Linkedin className="w-5 h-5" />
                  </a>
                  <a href="https://www.facebook.com/transflowerlearning" target="_blank" rel="noopener noreferrer"className="p-3 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-smooth" >
                    <Facebook className="w-5 h-5" />
                  </a>
                  <a href="https://www.youtube.com/@ravitambade-transflower" target="_blank" rel="noopener noreferrer"className="p-3 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-smooth" >
