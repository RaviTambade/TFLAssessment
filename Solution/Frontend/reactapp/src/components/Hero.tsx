    ...
    <section id="home" className="min-h-screen flex items-center pt-24 sm:pt-20 bg-gradient-hero">
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div ref={heroRef} className={`space-y-8 transition-all duration-1000 ${
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button  variant="hero" size="lg" onClick={() => document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' })}>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-3">
                <a href="https://www.linkedin.com/in/ravitambade/" target="_blank" rel="noopener noreferrer"className="p-2 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-smooth">
                  <Linkedin className="w-5 h-5" />
                </a>
                <a href="https://www.facebook.com/transflowerlearning" target="_blank" rel="noopener noreferrer"className="p-2 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-smooth">
                  <Facebook className="w-5 h-5" />
                </a>
                <a href="https://www.youtube.com/@ravitambade-transflower" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-primary/10 hover:bg-primary/20 text-primary transition-smooth">
          ...
          <div className={`relative transition-all duration-1000 delay-300 ${
            ...
            <img  src="/lovable-uploads/0b142dc4-57d1-4958-99cd-b268dab9f211.png" alt="Students collaborating in modern learning environment" className="relative rounded-3xl shadow-elegant w-full h-auto"/>
          </div>
        </div>
      </div>
    </section>
