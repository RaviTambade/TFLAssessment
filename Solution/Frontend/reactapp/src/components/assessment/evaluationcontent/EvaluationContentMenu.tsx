    ...
    <section className="py-16 sm:py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Evaluation Content Menu</h2>
        </div>
        {/* Card */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              {user.role_id === 4 && (
                <>
                  ...
                  <Button variant="hero" size="lg"className="group"
                    onClick={() => navigate("/models/evaluationcontent/questionsbyconceptid")}>
                  ...
                  <Button variant="hero" size="lg" className="group"
                    onClick={() =>navigate("/models/evaluationcontent/GetQuestionsByDate")}>
