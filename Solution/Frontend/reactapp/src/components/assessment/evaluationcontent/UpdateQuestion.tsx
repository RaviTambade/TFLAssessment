...
const UpdateQuestion = () => {
  ...
  const goToFullEditor = (questionId: number) => {navigate(`/models/evaluationcontent/edit/${questionId}`, {
    ...
    <section className="bg-background w-full py-6">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="flex justify-center gap-4 mb-8 flex-wrap">
          ...
          <Button onClick={() => { setMode("BY_ID"); setQuestions([]);}}>
            Update By ID
          </Button>
        </div>
        ...
        {mode === "BY_ID" && (
          <div className="flex justify-center gap-2 mb-8 flex-wrap">
            <input type="number" placeholder="Enter Question ID" className="border px-3 py-2 rounded" value={inputId}
                    ...
                    {questions.map((q) => (
                      <tr key={q.questionId} className="border-t">
                        ...
                        <td className="px-4 py-3">
                          <Button size="sm" onClick={() => goToFullEditor(q.questionId)}>
                            Edit
                          </Button>
                        </td>
                      </tr>
