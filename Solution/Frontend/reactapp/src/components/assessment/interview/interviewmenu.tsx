      ...
      <section className="py-16 sm:py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Interview Menu</h2> </div>
         {/* Card */}
              ...
              <div className="bg-gradient-hero p-6 sm:p-8">
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* STUDENT */}
                    {user.role_id === 2 && (<>
                      <Button variant="hero" size="lg" className="group" onClick={() => navigate("/models/interview/show-details-student") } >
                      Show Student Details<ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                      </Button>
                      ...
                      <Button variant="hero" size="lg" className="group" onClick={() => navigate("/models/interview/upcoming-interviews")}>
                        Upcoming Interviews
                      <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                      </Button>
                      <Button variant="hero" size="lg" className="group"
