      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-2">
            Upcoming{" "}
            <span className="bg-gradient-primary bg-clip-text text-transparent">Interviews</span>
            </h2>
        </div>
        {/* Interview List */}
        <div className="max-w-3xl mx-auto space-y-3">
         {interviews.map((interview,index) => (
            <Card onClick={() => navigate(`/models/interview/show-details-student/${interview.interviewId}`)} key={index}className="border-0 shadow-elegant overflow-hidden">
