        ...
        <Card className="bg-card/50 backdrop-blur-sm border border-border shadow-[var(--shadow-elegant)]">
          ...
          <CardContent className="p-6 sm:p-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="username" type="text" placeholder="Enter your contactnumber" value={username} onChange={(e) => setUsername(e.target.value)} autoComplete="username" className="pl-10" required />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="password" type={showPassword ? "text" : "password"} placeholder="Enter your password" value={password}
                    onChange={(e) => setPassword(e.target.value)} autoComplete="current-password" className="pl-10 pr-10" required />

                  <button type="button" onClick={() => setShowPassword((p) => !p)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-primary transition-smooth">
            ...
            <div className="flex justify-center mb-6">
              <button type="button" className="flex items-center gap-3 px-5 py-3 rounded-full bg-primary/10 text-primary hover:bg-primary/20 transition-smooth">
            ...
            <p className="text-center text-sm text-muted-foreground">
              Not a member?{" "}
              <button type="button" onClick={() => navigate("/models/membership/Register")} className="font-bold text-primary hover:text-accent transition-smooth">
                Register Now
              </button>
            </p>
          </CardContent>
