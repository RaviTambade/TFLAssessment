      ...
      <div className="max-w-7xl mx-auto">
        {!showAssessments ? (
          <div className="text-center mb-8">
            <button className="bg-[#E53935] text-white px-6 py-2 rounded-lg font-semibold shadow-md hover:bg-[#D32F2F] transition" onClick={getAssessments} > All Assessments</button>
          </div>
        ) : (
          <>
            {/* Filter Section */}
            <div className="bg-white mb-8 p-6 rounded-lg border border-gray-200">
              <div className="grid grid-cols-5 gap-4 mb-4">
                ...
                <div className="flex flex-col gap-2 justify-end">
                  ...
                  <button className="px-6 py-2 bg-[#E53935] text-white rounded-lg font-semibold hover:bg-[#D32F2F] transition">Filter</button>
                </div>
              </div>
            </div>
                      ...
                      {paginatedAssessments.map((assessment) => (
                        <tr key={assessment.id} className="border-b border-gray-100 hover:bg-gray-50 transition">
                          ...
                          <td className="px-6 py-5 text-center">
                              ...
                              (<button onClick={() => handleRestore(assessment.id)} 
                ...
                <div className="flex items-center justify-between text-gray-600">
                  ...
                  <div className="flex gap-2">
                    ...
                    {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                      <button
                        ...
                        className={`px-3 py-2 rounded-lg font-semibold transition ${
                          currentPage === page ? 'bg-[#E53935] text-white' : 'border border-gray-300 text-gray-600 hover:bg-gray-100'
                        }`}
                      >
                        {page}
                      </button>
                    ...
                    <button onClick={() => setCurrentPage(prev => Math.min(totalPages, prev + 1))}
                      ...
                      className="px-3 py-2 border border-gray-300 rounded-lg text-gray-600 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed"> Next</button>
                  </div>
                </div>
              </>
            )}
