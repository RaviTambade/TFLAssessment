          ...
          <Card className="border-0 shadow-elegant hover:shadow-glow transition-all">
            <CardContent className="p-6 flex justify-between items-center">
              <div>
                ...
                <Badge className="mt-3">{details.difficulty}</Badge>
              </div>
          ...
          <Card className="border-0 shadow-elegant hover:shadow-glow transition-all">
            <CardContent className="p-6 flex justify-between items-center">
              <div>
                ...
                <p className="text-3xl font-bold mt-2">{details.duration}</p>
          ...
          <Card className="border-0 shadow-elegant hover:shadow-glow transition-all">
            <CardContent className="p-6 flex justify-between items-center">
              <div>
                ...
                <p className="font-semibold mt-2">{new Date(details.createdAt).toLocaleDateString()}</p>
              </div>
          ...
          <Card className="border-0 shadow-elegant hover:shadow-glow transition-all">
            <CardContent className="p-6 flex justify-between items-center" >
              <div>
                ...
                <p className="text-3xl font-bold mt-2">{details.studentName.split(",").length}</p>
              </div>
        ...
        <Card className="border-0 shadow-elegant">
          <CardContent className="p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              ...
              <div key={ids[index]} onClick={() =>navigate(`/models/membership/UserProfile/${ids[index]}`)}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground"> Assigned Student</p>
                  </div>
                </div>
              </div>
            ))}
